...
export const data: SiteData = {
  ...
  skillCategories: [
    {
      ...
      skills: [
        { name: 'Conception de programmes', highlighted: true },
        { name: 'Référentiels RNCP & Qualiopi', highlighted: true, badge: 'Certifié' },
        { name: 'Évaluation des compétences' },
        { name: 'Syllabi & blocs de compétences' },
        { name: 'Innovation pédagogique' },
        { name: 'Technologie éducative (EdTech)' },
      ],
    },
    {
      ...
      skills: [
        { name: 'Coordination multi-campus', highlighted: true, badge: '6 campus' },
        { name: 'Conduite du changement', highlighted: true },
        { name: 'Management transversal' },
        { name: 'Gestion de projet' },
        { name: 'Pilotage de la qualité' },
        { name: 'Pilotage budgétaire' },
        { name: "Animation d'équipes" },
    ...
    },
    {
      ...
      skills: [
        { name: 'ERP pédagogiques (Yparéo)', highlighted: true },
        { name: 'LMS / Plateformes pédagogiques' },
        { name: 'Suite Office & Google Workspace' },
        { name: 'Reporting & Tableaux de bord' },
  ...
  ui: {
    ...
    ledger: {
      ...
      headline: '{count} paris engagés en parallèle de mon poste.',
      thesis:
